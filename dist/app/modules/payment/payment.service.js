...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updatedPayment = yield payment_model_1.Payment.findOneAndUpdate({ transactionId: query.transactionId }, { status: payment_interface_1.PAYMENT_STATUS.PAID }, { new: true, runValidators: true, session: session });
        if (!updatedPayment) {
...
const failPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    session.startTransaction();
    try {
        const updatedPayment = yield payment_model_1.Payment.findOneAndUpdate({ transactionId: query.transactionId }, { status: payment_interface_1.PAYMENT_STATUS.FAILED }, { new: true, runValidators: true, session: session });
